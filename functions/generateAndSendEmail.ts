  ...
  try {
    ...
    switch (emailType) {
      ...
      case 'department_report':
        subject = context.subject || 'Department Performance Report';
        body = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #f8f9fa;">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 40px 30px; text-align: center; border-radius: 10px 10px 0 0;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold;">📊 ${context.subject || 'Department Report'}</h1>
              <p style="margin: 10px 0 0 0; font-size: 14px; opacity: 0.9;">
                ${context.department === 'boibari' ? '📚 Boibari Department' : context.department === 'prodhan_com_e_commerce' ? '🛒 Prodhan.com E-Commerce' : 'Finance Department'}
              </p>
            </div>
            ...
            <div style="background: white; padding: 40px 30px;">
              <p style="font-size: 16px; color: #333; margin-bottom: 25px;">
                Dear <strong>${context.recipientName}</strong>,
              </p>

              <p style="font-size: 15px; color: #555; line-height: 1.7; margin-bottom: 30px;">
                Please find below your department's performance summary. ${context.pdfUrl ? 'A detailed PDF report is attached for your reference.' : ''}
              </p>

              <!-- Report Content -->
              <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-left: 5px solid #667eea; padding: 25px; border-radius: 8px; margin: 25px 0;">
                <pre style="font-family: 'Segoe UI', Arial, sans-serif; color: #2d3748; line-height: 2; white-space: pre-wrap; margin: 0; font-size: 14px;">
${context.body}
                </pre>
              </div>

              ${context.pdfUrl ? `
              <div style="background: #e0e7ff; padding: 20px; border-radius: 10px; margin: 25px 0; text-align: center;">
                <p style="margin: 0 0 15px 0; color: #3730a3; font-weight: 600;">📎 Detailed Report Attached</p>
                <a href="${context.pdfUrl}" 
                   style="display: inline-block; background: #667eea; color: white; padding: 12px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 15px;">
                  📥 Download PDF Report
                </a>
              </div>
              ` : ''}
              ...
              <div style="margin-top: 35px; padding-top: 25px; border-top: 2px solid #e5e7eb;">
                <p style="font-size: 14px; color: #6b7280; line-height: 1.6;">
                  This is an automated report generated by Bee ERP. For any questions or clarifications, please contact your department head or system administrator.
                </p>
              </div>
            </div>

            <!-- Footer -->
            <div style="background: #1f2937; color: white; padding: 30px; text-align: center; border-radius: 0 0 10px 10px;">
              <p style="margin: 0; font-size: 18px; font-weight: bold; color: #a78bfa;">
                🐝 Bee ERP System
              </p>
