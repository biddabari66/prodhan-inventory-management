...
Deno.serve(async (req) => {
    ...
    try {
        ...
        const { template, data, report_date, submitted_by, department, notes } = await req.json();
        ...
        // ... (rest of the budget report generation logic) ...
        doc.autoTable({
            // ...
            styles: fontManager.getAutoTableStyles(),
            headStyles: { ...fontManager.getAutoTableStyles(), fillColor: [52, 152, 219] },
            // ...
        });
        ...
        return new Response(pdfBytes, {
            status: 200,
            headers: { 'Content-Type': 'application/pdf', 'Content-Disposition': 'attachment; filename=budget_report.pdf' }
        });
