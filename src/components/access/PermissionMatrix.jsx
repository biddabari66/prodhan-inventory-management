...
const MODULES = [
  { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard, category: 'Core' },
  { id: 'crm', name: 'CRM & Leads', icon: Target, category: 'Sales' },
  { id: 'lead_database', name: 'Lead Database', icon: Calendar, category: 'Sales' },
  { id: 'followup', name: 'Follow Up', icon: Phone, category: 'Sales' },
  { id: 'whatsapp', name: 'WhatsApp', icon: MessageSquare, category: 'Sales' },
  { id: 'admissions', name: 'Admissions', icon: UserCheck, category: 'Academic' },
  { id: 'students', name: 'Students', icon: Users, category: 'Academic' },
  { id: 'courses', name: 'Courses', icon: BookOpen, category: 'Academic' },
  { id: 'income', name: 'Income', icon: TrendingUp, category: 'Finance' },
  { id: 'expenses', name: 'Expenses', icon: TrendingDown, category: 'Finance' },
  { id: 'incentives', name: 'Incentives', icon: Award, category: 'Finance' },
  { id: 'budget', name: 'Budgeting', icon: Calculator, category: 'Finance' },
  { id: 'payroll_report', name: 'Payroll Report', icon: FileSignature, category: 'Finance' },
  { id: 'finance_reports', name: 'Finance Reports', icon: BarChart3, category: 'Finance' },
  { id: 'employees', name: 'Employees', icon: Users, category: 'HR' },
  { id: 'attendance', name: 'Attendance', icon: Clock, category: 'HR' },
  { id: 'my_time', name: 'My Time', icon: UserIcon, category: 'HR' },
  { id: 'performance', name: 'Performance Hub', icon: Briefcase, category: 'HR' },
  ...
  { id: 'inventory', name: 'Inventory', icon: Warehouse, category: 'Operations' },
