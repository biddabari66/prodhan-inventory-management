    ...
    <Card className="premium-card mb-4">
      <CardContent className="p-4 sm:p-6 text-center">
        <div className="space-y-3">
          <div className="text-4xl sm:text-6xl font-bold font-display text-gradient tabular-nums">
            {format(currentTime, 'HH:mm:ss')}
          </div>
          <div className="text-stone-500 text-base sm:text-lg">
            {format(currentTime, 'EEEE, d MMMM yyyy')}
          </div>
          <div className="flex items-center justify-center gap-2">
            <Clock className="w-4 h-4 text-violet-500" />
            <span className="text-emerald-950 text-sm font-semibold">Live Time</span>
          </div>
        </div>
      </CardContent>
    </Card>
...
export default function AttendancePage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header with Bangladesh Time Indicator */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold font-display text-gradient">Attendance System</h1>
          <p className="text-sm sm:text-base text-muted-foreground">🇧🇩 Bangladesh timezone-verified attendance tracking</p>
        </div>
        <div className="flex items-center gap-3">
          {lastDataLoad && (
            <div className="text-xs text-muted-foreground">
              Last updated: {format(lastDataLoad, 'HH:mm')} BD Time
            </div>
          )}
          <Button 
            variant="outline" 
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm text-green-600 p-2 bg-green-500/10 rounded-lg">
      ...
      {/* Data Loading Indicator - Only show during manual refresh */}
      {isDataLoading && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center gap-3">
            <Loader2 className="w-5 h-5 animate-spin text-blue-600" />
            <span className="text-blue-800 font-medium">⚡ Optimized loading...</span>
          </div>
        </div>
      )}
      ...
      <Tabs defaultValue="checkinout" className="space-y-4 sm:space-y-6">
        ...
        <TabsContent value="checkinout" className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
            {/* Attendance Actions - Mobile Optimized */}
            <Card className="premium-card">
              ...
              <CardContent className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className="bg-[#700b84] text-primary-foreground px-4 py-2 text-base font-semibold inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-primary/90 w-full h-12 sm:h-14 sm:text-lg"
                  >
                    {isSubmitting ? (
